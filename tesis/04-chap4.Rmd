...
<!-- ```{r fuentes, results='asis', fig.cap="Fuentes de datos"} -->
<!-- tabla <- data.table(Nombre = c(rep("Avisos laborales", 3), " ",rep("Avisos laborales", 7),"PEA", "ECH", "Tasa desempleo", "Encuesta Internet"), -->
<!--                     Fuente = c(rep("Gallito", 3), " ", rep("Gallito", 2),"Buscojobs", "Computrabajo", "Gallito", "Buscojobs", "Computrabajo", "INE", "INE", "INE", "CIFRA"), -->
<!--                     Extraida = c("(ref:Urrestarazu1997)", "Biblioteca Nacional", "Biblioteca Nacional"," ", "CERES", "(ref:Alma2011)", "Diario El País", "WaybackMachine", "WaybackMachine", "Portal Gallito", "Portal Buscojobs", "Portal Computrabajo", "(ref:Urrestarazu1997)", "IECON", "INE", "CIFRA"), -->
...
<!-- kableExtra::kable(tabla ,row.names = F, align = "c", caption = "Fuentes de datos",  -->
<!--                   escape = FALSE, booktabs = TRUE, format = "latex", longtable = F,  -->
<!--                   col.names = c("Nombre", "Fuente", "Extraída", "Periodo") -->
<!--                   ) %>%  -->
