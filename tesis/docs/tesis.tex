...
\begin{figure}
\includegraphics[width=\maxwidth]{tesis_files/figure-latex/IndiceVacantesAvisos-1.pdf}
...
\begin{figure}
\includegraphics[width=\maxwidth]{tesis_files/figure-latex/FIRs-1.pdf}
...
\begin{figure}
\includegraphics[width=\maxwidth]{tesis_files/figure-latex/curvasEQ-1.pdf}
...
Por último se muestra la especificación de los priors utilizados en la estimación del modelo. Se utilizan los valores por defecto generados por Primiceri (\protect\hyperlink{ref-Primiceri2005}{2005}).
\begin{table}
...
\end{figure}
\begin{figure}
\includegraphics[width=\maxwidth]{tesis_files/figure-latex/IndiceAvisosTC-1.pdf}
...
\\textit{UM} 80-01 & ADF-KPSS-PP & 1 & HEGY-OCSB-CH & 1-0-0\\
...
\end{figure}
\begin{figure}
\includegraphics[width=\maxwidth]{tesis_files/figure-latex/testME2-1.pdf}
...
\caption{\label{tab:vcovHAC-lumley}Coeficientes de cada periodo (Lumley)}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}[t]{ccccccc}
...
\midrule
1981 Q1--1990 Q2 & $\hat{\beta}_0$ & 1.33 & 0.65 & 2.05 & 0.05 & *\\
1981 Q1--1990 Q2 & $\hat{\beta}_1$ & -1.08 & 0.26 & -4.24 & 0.00 & ***\\
1981 Q1--1990 Q2 & $\hat{\sigma}^2$ & 0.04 & 0.01 & 3.09 & 0.00 & **\\
1990 Q3--1996 Q2 & $\hat{\beta}_0$ & 0.26 & 0.31 & 0.85 & 0.40 & \\
1990 Q3--1996 Q2 & $\hat{\beta}_1$ & -0.32 & 0.13 & -2.40 & 0.03 & *\\
\addlinespace
1990 Q3--1996 Q2 & $\hat{\sigma}^2$ & 0.01 & 0.01 & 2.42 & 0.02 & *\\
1996 Q3--2013 Q1 & $\hat{\beta}_0$ & 1.48 & 0.28 & 5.31 & 0.00 & ***\\
1996 Q3--2013 Q1 & $\hat{\beta}_1$ & -0.74 & 0.13 & -5.87 & 0.00 & ***\\
1996 Q3--2013 Q1 & $\hat{\sigma}^2$ & 0.01 & 0.00 & 3.15 & 0.00 & **\\
2013 Q2--2018 Q4 & $\hat{\beta}_0$ & 1.79 & 0.24 & 7.48 & 0.00 & ***\\
\addlinespace
2013 Q2--2018 Q4 & $\hat{\beta}_1$ & -1.08 & 0.12 & -9.40 & 0.00 & ***\\
2013 Q2--2018 Q4 & $\hat{\sigma}^2$ & 0.01 & 0.00 & 3.47 & 0.00 & **\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \textit{Notas:} 
...
\caption{\label{tab:kernHAC}Coeficientes de cada periodo (Kernel)}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}[t]{ccccccc}
...
Periodo & Coeficiente & Estimación & Estándar error & Estadístico & p-valor & Significación\\
\midrule
1981 Q1--1990 Q2 & $\hat{\beta}_0$ & 1.33 & 0.64 & 2.08 & 0.04 & *\\
1981 Q1--1990 Q2 & $\hat{\beta}_1$ & -1.08 & 0.26 & -4.11 & 0.00 & ***\\
1981 Q1--1990 Q2 & $\hat{\sigma}^2$ & 0.04 & 0.01 & 3.66 & 0.00 & ***\\
1990 Q3--1996 Q2 & $\hat{\beta}_0$ & 0.26 & 0.32 & 0.82 & 0.42 & \\
1990 Q3--1996 Q2 & $\hat{\beta}_1$ & -0.32 & 0.14 & -2.30 & 0.03 & *\\
\addlinespace
1990 Q3--1996 Q2 & $\hat{\sigma}^2$ & 0.01 & 0.01 & 2.05 & 0.05 & .\\
1996 Q3--2013 Q1 & $\hat{\beta}_0$ & 1.48 & 0.54 & 2.72 & 0.01 & **\\
1996 Q3--2013 Q1 & $\hat{\beta}_1$ & -0.74 & 0.25 & -2.95 & 0.00 & **\\
1996 Q3--2013 Q1 & $\hat{\sigma}^2$ & 0.01 & 0.01 & 1.65 & 0.10 & \\
2013 Q2--2018 Q4 & $\hat{\beta}_0$ & 1.79 & 0.20 & 9.02 & 0.00 & ***\\
\addlinespace
2013 Q2--2018 Q4 & $\hat{\beta}_1$ & -1.08 & 0.10 & -11.31 & 0.00 & ***\\
2013 Q2--2018 Q4 & $\hat{\sigma}^2$ & 0.01 & 0.00 & 3.86 & 0.00 & ***\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \textit{Notas:} 
...
\caption{\label{tab:NeweyWest}Coeficientes de cada periodo (Newey West)}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}[t]{ccccccc}
...
Periodo & Coeficiente & Estimación & Estándar error & Estadístico & p-valor & Significación\\
\midrule
1981 Q1--1990 Q2 & $\hat{\beta}_0$ & 1.33 & 0.59 & 2.26 & 0.03 & *\\
1981 Q1--1990 Q2 & $\hat{\beta}_1$ & -1.08 & 0.24 & -4.50 & 0.00 & ***\\
1981 Q1--1990 Q2 & $\hat{\sigma}^2$ & 0.04 & 0.01 & 3.86 & 0.00 & ***\\
1990 Q3--1996 Q2 & $\hat{\beta}_0$ & 0.26 & 0.25 & 1.03 & 0.32 & \\
1990 Q3--1996 Q2 & $\hat{\beta}_1$ & -0.32 & 0.11 & -2.93 & 0.01 & **\\
\addlinespace
1990 Q3--1996 Q2 & $\hat{\sigma}^2$ & 0.01 & 0.01 & 2.40 & 0.03 & *\\
1996 Q3--2013 Q1 & $\hat{\beta}_0$ & 1.48 & 0.61 & 2.44 & 0.02 & *\\
1996 Q3--2013 Q1 & $\hat{\beta}_1$ & -0.74 & 0.28 & -2.64 & 0.01 & *\\
1996 Q3--2013 Q1 & $\hat{\sigma}^2$ & 0.01 & 0.01 & 1.47 & 0.15 & \\
2013 Q2--2018 Q4 & $\hat{\beta}_0$ & 1.79 & 0.16 & 11.29 & 0.00 & ***\\
\addlinespace
2013 Q2--2018 Q4 & $\hat{\beta}_1$ & -1.08 & 0.07 & -14.70 & 0.00 & ***\\
2013 Q2--2018 Q4 & $\hat{\sigma}^2$ & 0.01 & 0.00 & 5.35 & 0.00 & ***\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \textit{Notas:} 
