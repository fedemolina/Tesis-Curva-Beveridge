...
En *Computrabajo* se extraen todas las publicaciones mensuales disponibles publicadas en el portal laboral _Computrabajo_ entre 2003 y 2018 a partir de _Waybackmachine_ y avisos laborales entre 2018 y 2019 mediante scraping del portal _Computrabajo_. La particularidad de este portal es que la cantidad de avisos publicados que se observa no se corresponde con la cantidad de avisos publicados en los últimos 30 días debido a que dicho portal mantiene avisos por más de 60 días, inclusive. 
...
Para despejar los avisos totales entre 1980 y 1995 se debe utilizar la *PEA* calculada por Urrestarazu, posteriormente se debe calcular dicha variable desde 1995 hasta 2019 y finalmente unir ambas estimaciones.
...
data.table::setnames(comparacion_gallito, old = names(comparacion_gallito), new = c("avisos sin duplicados", "avisos con duplicados", "avisos papel", "fecha", "ratio sin duplicados", "ratio con duplicados", "diferencia sin duplicados"))
...
kableExtra::kable_styling(latex_options = "scale_down", position = "center") %>%
  kableExtra::footnote(general = notas, #number = notas,
                       ...
                       general_title = "Notas:", 
                       footnote_as_chunk = F, threeparttable = TRUE, footnote_order = c("general"))
```
...
En el año 2019 se realiza scraping sobre el portal _Buscojobs_ extrayendo de forma mensual todos los avisos laborales disponibles y la información completa de cada aviso.
